...
Dictionary::Dictionary()
{
	...
	//水分5
	map.insert("arb50", "SoilVolume50");
	//频率5
	map.insert("arg50", "SoilFrequency50");
	//水分6
	map.insert("arb60", "SoilVolume60");
	//频率6
	map.insert("arg60", "SoilFrequency60");
	//水分7
	map.insert("arb80", "SoilVolume80");
	//频率7
	map.insert("arg80", "SoilFrequency80");
	//水分8
	map.insert("arb100", "SoilVolume100");
	//频率8
	map.insert("arg100", "SoilFrequency100");
	//分钟雨量
	...
	//两分钟风速
	map.insert("afc1", "WS_Avg2MWS2");
	//十分钟风向
	map.insert("aed1", "WD_Avg10MWD");
	//十分钟风速
	map.insert("afd1", "WS_Avg10MWS2");
	//最大风速的风向
	map.insert("aeg1", "WD_MaxWSD");
	//最大风速
	map.insert("afd1a", "WS_MaxWS2");
	//最大风速出现时间
	map.insert("afd1d", "WS_MaxWS2T");
	//当前时刻的瞬时风向
	map.insert("aea1", "WD_IWD");
	//当前时刻的瞬时风速
	map.insert("afa1", "WS_IWS2");
	//1分钟瞬时最大风速对应风向
	map.insert("aef1", "WD_Max1MIWSD");
	//分钟瞬时最大风速
	map.insert("afa1a", "WS_Max1MWS2");
	//极大风速的风向
	map.insert("aee1", "WD_EWSD");
	//极大风速
	map.insert("afa1e", "WS_EWS2");
	//极大风速时间
	map.insert("afa1f", "WS_EWS2T");
	...
	//路温传感器状态
	map.insert("y_abb", "RdTmprtSensorSts");
	//5cm地温传感器状态
