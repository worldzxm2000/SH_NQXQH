...
public:
    ...
    void setupUi(QWidget *ControlUI)
    {
        ...
        groupBox_WND->setGeometry(QRect(515, 15, 46, 26));
        ...
        TitleLabel_Name->setGeometry(QRect(50, 15, 91, 21));
        ...
        BdateTimeEdit->setDateTime(QDateTime(QDate(2018, 11, 1), QTime(0, 0, 0)));
        DownBtn = new QPushButton(groupBox_down);
        DownBtn->setObjectName(QStringLiteral("DownBtn"));
        DownBtn->setGeometry(QRect(180, 20, 71, 23));
    ...
    {
        ControlUI->setWindowTitle(QApplication::translate("ControlUI", "\345\260\217\346\260\224\345\200\231\350\247\202\346\265\213\344\273\252\350\256\276\345\244\207\346\216\247\345\210\266", nullptr));
        ...
        TitleLabel_Name->setText(QApplication::translate("ControlUI", "\345\260\217\346\260\224\345\200\231\350\247\202\346\265\213\344\273\252", nullptr));
